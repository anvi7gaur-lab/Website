...
function initScrollAnimations() {
    ...
    const animatedElements = document.querySelectorAll('section, .feature-card, .testimonial-card');
...
function enhanceButtons() {
    const buttons = document.querySelectorAll('.btn, .nav-btn, .mobile-nav-btn');
    buttons.forEach(btn => {
        // Add ripple effect
